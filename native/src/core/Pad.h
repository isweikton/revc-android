...
public:
	...
	bool GetPauseJustDown()       { return !!(NewKeyState.PAUSE && !OldKeyState.PAUSE) || gTouch.getButtonJustDown(BtnType::PAUSE); }
	...
	bool GetPause()               { return NewKeyState.PAUSE || gTouch.getButton(BtnType::PAUSE); }
