...
#define CARBLIP_MARKER_COLOR_R 50
#define CARBLIP_MARKER_COLOR_G 50
#define CARBLIP_MARKER_COLOR_B 50
#define CARBLIP_MARKER_COLOR_A 255

#define CHARBLIP_MARKER_COLOR_R 255
#define CHARBLIP_MARKER_COLOR_G 0
#define CHARBLIP_MARKER_COLOR_B 0
#define CHARBLIP_MARKER_COLOR_A 0

#define OBJECTBLIP_MARKER_COLOR_R 50
#define OBJECTBLIP_MARKER_COLOR_G 50
#define OBJECTBLIP_MARKER_COLOR_B 50
#define OBJECTBLIP_MARKER_COLOR_A 255

#define COORDBLIP_MARKER_COLOR_R 255
#define COORDBLIP_MARKER_COLOR_G 0
#define COORDBLIP_MARKER_COLOR_B 0
...
#ifdef ANDROID
	#define ANDROID_RADAR_SIZE(value) ((value) * ANDROID_RADAR_SCALE)
#else
	#define ANDROID_RADAR_SIZE(value) (value)
#endif
...
*/
#define RADAR_WIDTH (ANDROID_RADAR_SIZE((CDraw::ms_bFixRadar)  ? (82.0f) : (94.0f)))
#define RADAR_HEIGHT (ANDROID_RADAR_SIZE((CDraw::ms_bFixRadar) ? (82.0f) : (76.0f)))
#else
/*
	...
	most likely the guy used something like this:
		...
		int x = y * (640.0/512.0);
*/
#define RADAR_WIDTH (ANDROID_RADAR_SIZE(94.0f))
#define RADAR_HEIGHT (ANDROID_RADAR_SIZE(76.0f))
#endif
