...
// Android-specific frontend/game-flow overrides.
#define ANDROID_HIDE_FRONTEND_CURSOR
#define ANDROID_SHOW_BUILD_OVERLAY
// #define ANDROID_REALISTIC_WATER
#define ANDROID_DISABLE_PLAYER_IDLE_ANIMS
// #define ANDROID_DISABLE_PLAYER_DROWNING
#define ANDROID_DEFAULT_MAX_FPS 90
#define ANDROID_MAX_FPS_CAP 120
// Reduce baseline GPU load for mid-tier devices
#define ANDROID_DEFAULT_DRAW_DISTANCE 1.00f
#define ANDROID_REAL_DRAW_DISTANCE_SCALE 0.95f
#define ANDROID_GENERATION_DISTANCE_SCALE 1.10f
#define ANDROID_VEHICLE_GENERATION_DISTANCE_SCALE 0.82f
// Lower default densities to stabilize CPU/GPU on slower devices
#define ANDROID_DEFAULT_PED_DENSITY 0.30f
#define ANDROID_DEFAULT_CAR_DENSITY 0.25f
#define ANDROID_WATER_DRAW_DISTANCE_SCALE 1.08f
#define ANDROID_WAVY_WATER_DRAW_DISTANCE_SCALE 1.10f
#define ANDROID_DEFAULT_POSTFX_INTENSITY 0.0f
#define ANDROID_DEFAULT_VEHICLE_SHININESS 0.10f
#define ANDROID_DEFAULT_LIGHTMAP_MULT 0.0f
#define ANDROID_DEFAULT_GLOSS_MULT 0.0f
#define ANDROID_DEFAULT_RIMLIGHT_MULT 0.0f
#define ANDROID_STREAMING_MEMORY_CAP_MB 256
#define ANDROID_STREAMING_REQUEST_BUDGET 12
#define ANDROID_STREAMING_DYNAMIC_REQUEST_BUDGET 8
#define ANDROID_STREAMING_VEHICLE_BUDGET 7
#define ANDROID_STREAMING_PED_BUDGET 7
#define ANDROID_STREAMING_VEHICLE_COOLDOWN_MS 160
#define ANDROID_STREAMING_PED_COOLDOWN_MS 140
#define ANDROID_STREAMING_HEAVY_CLEANUP_COOLDOWN_MS 360
#define ANDROID_STREAMING_FRAME_TIME_SOFT_LIMIT_MS 13.5f
#define ANDROID_STREAMING_FRAME_TIME_HARD_LIMIT_MS 18.0f
#define ANDROID_TEXTURE_ANISOTROPY 1
#define ANDROID_RADAR_SCALE 1.25f
#define ANDROID_RADAR_TOP_OFFSET 28.0f
