...
public:
	...
	static float GetFarClip(void) {
#ifdef ANDROID
		return m_fCurrentFarClip * ANDROID_REAL_DRAW_DISTANCE_SCALE;
#else
		return m_fCurrentFarClip;
#endif
	}
	static float GetFogStart(void) {
#ifdef ANDROID
		return m_fCurrentFogStart * ANDROID_REAL_DRAW_DISTANCE_SCALE;
#else
		return m_fCurrentFogStart;
#endif
	}
