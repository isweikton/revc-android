...
public:
	...
	CAnimBlendAssociation* currentClimbingStandAnim = nullptr;

	bool bIsStartHighClimbing = false;
	bool bIsClimbingHighJump = false;
	bool bIsClimbingIdle = false;
	bool bIsClimbingPull = false;
	CVector newClimbingIdlePosition;
	CVector newStartClimbingIdlePosition;
	CAnimBlendAssociation* currentClimbingIdleAnim = nullptr;

	bool bIsClimbingJumpB = false;
	CVector newStartClimbingJumpBPosition;
	CVector newClimbingJumpBPosition;
	CAnimBlendAssociation* currentClimbingJumpBAnim = nullptr;

	CAnimBlendAssociation* currentJumpGlideAnim = nullptr;
#endif
