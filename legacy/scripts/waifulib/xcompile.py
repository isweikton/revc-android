...
ANDROID_NDK_SUPPORTED = [10, 19, 20, 21, 23, 25, 26, 27, 28]
...
ANDROID_NDK_API_MIN = { 10: 3, 19: 16, 20: 16, 21: 16, 23: 16, 25: 16, 26: 16, 27: 16, 28: 16 } # minimal API level ndk revision supports
...
class Android:
	...
	def ar(self):
		if self.is_clang() or self.is_host():
			return os.path.join(self.gen_gcc_toolchain_path(), 'bin', 'llvm-ar')
